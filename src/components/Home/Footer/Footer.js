    ...
    return (
        <div className="footer">
            <div className="footer__content text-center">
                <div className="row">
                    <div className="col-12 col-sm-12 col-md-6 col-lg-3 item">
                        <p>CyberSoft</p>
                        <ul>
                    ...
                    <div className="col-12 col-sm-12 col-md-6 col-lg-3 item row" style={{ justifyContent: 'space-around' }}>
                        <p className="col-12">Điều khoản sử dụng</p>
                        <ul className="col-12 text-center" >
